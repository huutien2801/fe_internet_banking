                    ...
                    <div class="row">
                      <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <multiselect v-model="statusValue" :options="statusOptions" :max="1" :multiple="true" :close-on-select="true" :clear-on-select="true" :preserve-search="true" :show-labels="false" placeholder="Chọn ngân hàng muốn chuyển" label="text" track-by="id" :preselect-first="false" @select="onSelectCategoryJob($event)" @remove="onRemoveGender($event)" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
