            ...
            <div class="row container-account">
                ...
                <div class="col-lg-11" style="padding-left:0px">
                    <div class="header-title">
                        <span class="main-title">Chuyển khoản liên ngân hàng</span>
                        <span class="sub-title">(Chuyển khoản liên ngân hàng là đối tác của 3TBank)</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <multiselect v-model="partnerValue" :options="partnerOption" :max="1" :multiple="true" :close-on-select="true" :clear-on-select="true" :preserve-search="true" :show-labels="false" placeholder="Lọc theo thời gian" label="text" track-by="id" :preselect-first="false" @remove="onRemovePartner($event)" />
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        onSelectReceiver: function (obj) {
            ...
            let info = this.partnerOption.find(partner => {
                return partner.id == partnerCode
            })
        ...
        onRemovePartner: function (obj) {
            this.receiverAccountNumber = ''
            this.receiverFullname = ''
            this.exchangeUserValue = null
        }
    },
    components: {
        Multiselect,
