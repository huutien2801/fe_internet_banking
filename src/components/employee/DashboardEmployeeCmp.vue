...
<script>
import EmployeeNavBarCmp from './employee-common/EmployeeNavBarCmp'
import EmployeeSidebarCmp from './employee-common/EmployeeSidebarCmp'
export default {
  name: "user-dashboard",
  data: function () {
    return {
      imgAva:
        "https://thegioidienanh.vn/stores/news_dataimages/anhvu/032020/09/16/in_article/0545_Ynh_4.jpg",
